...
import { Calendar, Download, Heart, ImageIcon, Mail, User, Trash2 } from "lucide-react"
...
export default function ProfilePage() {
  ...
  // Call server API to delete account securely
  const handleDeleteAccount = async () => {
    if (!user) return

    const confirmDelete = window.confirm(
      "WARNING: Are you absolutely sure you want to delete your account? This action is irreversible and will permanently delete all associated data."
    )
