...
import { Brain, Download, Heart, Search, Sparkles, Zap, Filter } from "lucide-react"
      ...
      <div className="@container mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-background/60 backdrop-blur-sm">
            <CardHeader className="pb-4">
              <CardDecorator>
                <Filter className="size-6 text-indigo-600" />
              </CardDecorator>
              <h3 className="text-xl font-semibold mt-4">Advanced Filters</h3>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Refine your search with color palettes, image orientation, and AI mood tags for precise results.
              </p>
            </CardContent>
          </Card>
